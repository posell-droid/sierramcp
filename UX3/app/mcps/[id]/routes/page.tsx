...
function BreadcrumbNav({ mcpName }: { mcpName: string }) {
  return (
    <Breadcrumb className="mb-6">
      <BreadcrumbList>
        ...
        <BreadcrumbItem>
          <BreadcrumbLink href={`/mcps/${mcpName}`}>{mcpName}</BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator>
          <ChevronRight className="h-4 w-4" />
        </BreadcrumbSeparator>
    ...
    <div className="min-h-screen bg-muted/30 p-6">
      <div className="mx-auto max-w-7xl">
        ...
        <Suspense fallback={<div className="h-6 mb-6" />}>
          <BreadcrumbNav mcpName={mcp?.name || ""} />
        </Suspense>
            ...
            <DialogFooter>
              <div className="flex justify-between w-full">
                ...
                <div className="flex gap-2">
                  ...
                  {wizardStep < 5 ? (
                    <Button
                      onClick={() => setWizardStep((s) => Math.min(5, s + 1) as any)}
                      disabled={
