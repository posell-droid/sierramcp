  ...
  const [data] = useState<Deployment[]>([
    {
      ...
      minTasks: 2,
      maxTasks: 10,
      endpoint: "https://finance-prod.mcp.gatemcp.io",
    ...
    },
    {
      ...
      minTasks: 1,
      maxTasks: 3,
      endpoint: "https://finance-sandbox.mcp.gatemcp.io",
    ...
    },
    {
      ...
      minTasks: 1,
      maxTasks: 2,
      endpoint: "https://finance-test.mcp.gatemcp.io",
...
export default function MCPDeploymentsPage({ params }: { params: Promise<{ id: string }> }) {
  const { id: mcpId } = use(params)
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href={`/mcps/${mcpId}`}>Finance Analytics</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
              <ChevronRight className="h-4 w-4" />
            </BreadcrumbSeparator>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <DialogFooter>
              <div className="flex justify-between w-full">
                <div>
                  {wizardStep > 1 && (
                    <Button variant="outline" onClick={() => setWizardStep((s) => Math.max(1, s - 1) as any)}>
                      Back
                    </Button>
                  )}
                </div>
                    ...
                    <CardContent className="p-4 space-y-2 text-sm">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <Button
                          ...
                          onClick={() => handleCopyEndpoint(selectedDeployment.endpoint, {} as any)}
                        >
